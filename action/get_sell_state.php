...
foreach ($mysqli->query('SELECT product_list.product_id, product_registry.registry_id, product_list.title, product_registry.count, units.unit, product_registry.create_date, product_registry.expire_date
