...
$result = $mysqli->query("SELECT COUNT(*) FROM operation_add");
...
$result = $mysqli->query("SELECT operation_history.document_number, operation_add.product_name, operation_add.count, operation_add.create_date, operation_add.expire_date, operation_add.milk_fat, operation_add.milk_solidity, operation_add.milk_acidity 
FROM operation_add, operation_history 
WHERE operation_add.operation_id = operation_history.operation_id
LIMIT $start, $num");
         ...
         <div class="content-wrapper">
            ...
            <div class="card-panel white">
               ...
               <ul class="pagination">
                  ...
                  if ($page != 1) $pervpage = '<li class="waves-effect"><a href= ./add_history.php?page=' . ($page - 1) . '><i class="material-icons">chevron_left</i></a></li>';
                  ...
                  if ($page != $total) $nextpage = '<li class="waves-effect"><a href= ./add_history.php?page=' . ($page + 1) . '><i class="material-icons">chevron_right</i></a></li>';
                  //<a href= ./product_list.php?page=' . $total . '>>></a>';

                  // Находим две ближайшие станицы с обоих краев, если они есть
                  if ($page - 2 > 0) $page2left = '<li class="waves-effect"> <a href= ./add_history.php?page=' . ($page - 2) . '>' . ($page - 2) . '</a> </li>';
                  if ($page - 1 > 0) $page1left = '<li class="waves-effect"> <a href= ./add_history.php?page=' . ($page - 1) . '>' . ($page - 1) . '</a> </li>';
                  if ($page + 2 <= $total) $page2right = '<li class="waves-effect"> <a href= ./add_history.php?page=' . ($page + 2) . '>' . ($page + 2) . '</a> </li>';
                  if ($page + 1 <= $total) $page1right = '<li class="waves-effect"> <a href= ./add_history.php?page=' . ($page + 1) . '>' . ($page + 1) . '</a> </li>';
